...
public class MenuExample {
    public static void main(String[] args) {
        ...
        editMenu.setFont(new java.awt.Font("Arial", java.awt.Font.PLAIN, 30));
        JMenuItem cutItem = new JMenuItem("Cut");
        JMenuItem copyItem = new JMenuItem("Copy");
        JMenuItem pasteItem = new JMenuItem("Paste");
        cutItem.setFont(new java.awt.Font("Arial", java.awt.Font.PLAIN, 30));
        copyItem.setFont(new java.awt.Font("Arial", java.awt.Font.PLAIN, 30));
        pasteItem.setFont(new java.awt.Font("Arial", java.awt.Font.PLAIN, 30));
